...
- safe: `lint` — `index-catalog` cap **3**; findings `index-dup-agents`, `log-unknown-type`, `decision-body-bloat`, `memory-ghost-docs`, `agents-docs-gap`; report says re-run consolidate until that warning band is empty.
