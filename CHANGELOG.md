...
- Root, vendor, and hooks READMEs match the write floor (five destinations including `decisions.md` and fail-closed reusable lesson), five shared hook scripts (including print-evidence), and `/learn` as explicit capture.
